...
export function getVentasPorPeriodo(startDate, endDate, token) {
  return request(
    `/v1/reportes/ventas/periodo?fechaInicio=${startDate}&fechaFin=${endDate}`,
    {
      token,
      method: "GET",
    },
...
export function getVentasPorProducto(startDate, endDate,
  ...
  return request(
    `/v1/reportes/ventas/producto?fechaInicio=${startDate}&fechaFin=${endDate}&page=${page}&size=${size}&sortBy=${sortBy}&sortDirection=${sortDirection}`,
    {
      token,
      method: "GET",
    },
...
export function getVentasPorCategoria(
  startDate,
  endDate,
  page = 0,
  size = 10,
...
export function getProductosStockBajo(
  stockMinimo = 10,
  page = 0,
  size = 10,
  token,
...
export function getClientesFrecuentes(
  startDate,
  endDate,
  page = 0,
  size = 10,
...
export function getClientesMejorCompra(
  startDate,
  endDate,
  page = 0,
  size = 10,
  ...
  return request(
    `/v1/reportes/clientes/mejor-compra?fechaInicio=${startDate}&fechaFin=${endDate}&page=${page}&size=${size}`,
    {
      token,
      method: "GET",
    },
...
export function getMetricasRapidas(startDate, endDate, token) {
  return request(
    `/v1/reportes/metricas/rapidas?fechaInicio=${startDate}&fechaFin=${endDate}`,
    {
      token,
      method: "GET",
    },
